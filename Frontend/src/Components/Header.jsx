...
const Header = () => {
  ...
  return (
    <div className='flex flex-col justify-center items-center text-center my-20' initial={{opacity:0.2,y:100}} transition={{duration:1}} whileInView={{opacity:1,y:0}} viewport={{once:true}}>
      ...
      <button className='sm:text-lg text-white bg-black w-auto mt-8 px-12 py-2.5 flex items-center gap-2 rounded-full cursor-pointer'  onClick={onClickHandler} >Generate Image
        <img className='h-5' src={assets.star_group} alt="" />
      </button>
      <div className='flex flex-wrap justify-center mt-16 gap-3  ' initial={{opacity:0,y:-20}} transition={{duration:1}} animate={{opacity:1,y:0}} viewport={{once:true}}>
